...
export type ProductStatusUpdateRequestStatus = typeof ProductStatusUpdateRequestStatus[keyof typeof ProductStatusUpdateRequestStatus];


export const ProductStatusUpdateRequestStatus = {
  ACTIVE: 'ACTIVE',
  INACTIVE: 'INACTIVE',
  SOLD_OUT: 'SOLD_OUT',
} as const;
